    ...
    return (
        <div>
            <div className=' flex justify-between items-center bg-[#282828] p-2'>
                <h1 className=' font-bold text-xl text-white'>NEWS <span className=" text-blue-600 font-bold">24/7</span></h1>
                <button onClick={changetheme}>Dark mode</button>
            </div>
            <hr />
            <div className=' sm:p-2 bg-[#282828] h-10'>
                <ul className=' flex overflow-x-auto gap-5 pb-1 font-semibold sm:mx-3 cursor-pointer text-white '>
                    {
                        arr.map((item, index) => {
